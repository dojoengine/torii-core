...
use sqlx::{
    query, query_as, query_scalar, Connection, Decode, Encode, Executor, PgConnection, Type,
};
...
pub type PgQuery = FlexQuery<Postgres>;

pub trait PgDbConnection: DbConnection<Postgres> {}
impl<T: PgDbConnection> PgDbConnection for T {}
