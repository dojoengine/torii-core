...
export class ToriiClient extends BaseSinkClient {
  ...
  async getVersion(
    ...
    return this.unaryCall<GetVersionResponse>('/torii.Torii/GetVersion', request as unknown as Record<string, unknown>, { ...options, requestSchema: GetVersionRequestSchema, responseSchema: GetVersionResponseSchema });
  }
  ...
  async listTopics(
    ...
    return this.unaryCall<ListTopicsResponse>('/torii.Torii/ListTopics', request as unknown as Record<string, unknown>, { ...options, requestSchema: ListTopicsRequestSchema, responseSchema: ListTopicsResponseSchema });
  }
  ...
  async *subscribeToTopicsStream(
    ...
    yield* this.streamCall<TopicUpdate>('/torii.Torii/SubscribeToTopicsStream', request as unknown as Record<string, unknown>, { ...options, requestSchema: SubscriptionRequestSchema, responseSchema: TopicUpdateSchema });
  }
  ...
  async onSubscribeToTopicsStream(
    ...
    return this._subscribeWithCallbacks<TopicUpdate>('/torii.Torii/SubscribeToTopicsStream', request as unknown as Record<string, unknown>, onMessage, onError, onConnected, TopicUpdateSchema);
  }
