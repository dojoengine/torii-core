...
export class LogSinkClient extends BaseSinkClient {
  ...
  async queryLogs(
    ...
    return this.unaryCall<QueryLogsResponse>('/torii.sinks.log.LogSink/QueryLogs', request as Record<string, unknown>, { ...options, requestSchema: QueryLogsRequestSchema, responseSchema: QueryLogsResponseSchema });
  }
  ...
  async *subscribeLogs(
    ...
    yield* this.streamCall<LogUpdate>('/torii.sinks.log.LogSink/SubscribeLogs', request as Record<string, unknown>, { ...options, requestSchema: QueryLogsRequestSchema, responseSchema: LogUpdateSchema });
  }
  ...
  async onSubscribeLogs(
    ...
    return this._subscribeWithCallbacks<LogUpdate>('/torii.sinks.log.LogSink/SubscribeLogs', request as Record<string, unknown>, onMessage, onError, onConnected, LogUpdateSchema);
  }
}
